...
const SongCard = ({ song, isPlaying, activeSong, data, i }) => {
  const songImage = song.images && song.images.coverart ? song.images.coverart : song.images?.background;
  ...
  return (
  <div className="flex flex-col w-[207px] p-4 bg-white/5 bg-opacity-80 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer">
